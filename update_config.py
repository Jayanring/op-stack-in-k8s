...
yaml_data["spec"]["template"]["spec"]["initContainers"][0]["image"] = (
    DOCKER_REGISTRY + "/" + DOCKER_REPO + "/op-deployer:compiled-v0.7.0"
)
yaml_data["spec"]["template"]["spec"]["containers"][0]["image"] = (
    DOCKER_REGISTRY + "/" + DOCKER_REPO + "/op-node:v0.5.0"
)
...
yaml_data["spec"]["template"]["spec"]["initContainers"][0]["image"] = (
    DOCKER_REGISTRY + "/" + DOCKER_REPO + "/op-geth-free:v0.3.0"
)
yaml_data["spec"]["template"]["spec"]["containers"][0]["image"] = (
    DOCKER_REGISTRY + "/" + DOCKER_REPO + "/op-geth-free:v0.3.0"
)
yaml_data["spec"]["template"]["spec"]["containers"][1]["image"] = (
    DOCKER_REGISTRY + "/" + DOCKER_REPO + "/op-node:v0.5.0"
)
yaml_data["spec"]["template"]["spec"]["containers"][2]["image"] = (
    DOCKER_REGISTRY + "/" + DOCKER_REPO + "/op-batcher:v0.1.0"
)
