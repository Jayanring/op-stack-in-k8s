...
yaml_data["spec"]["template"]["spec"]["initContainers"][0]["image"] = DOCKER_REGISTRY + '/' + DOCKER_REPO + '/op-geth-free:v0.1.0'
yaml_data["spec"]["template"]["spec"]["containers"][0]["image"] = DOCKER_REGISTRY + '/' + DOCKER_REPO + '/op-geth-free:v0.1.0'
